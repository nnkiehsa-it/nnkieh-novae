...
async function issuePolicyParams(database: BackendDatabase, auth: AuthContext, actorCanManage: boolean) {
...
export async function moderateIssueStatus(payload: JsonRecord, auth: AuthContext, database: BackendDatabase) {

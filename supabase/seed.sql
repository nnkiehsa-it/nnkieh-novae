-- Local development seed. Supabase runs this after every `supabase db reset`.
-- The records are intentionally deterministic and contain no production data.
...
insert into app_private.issue_categories (
  ...
  ('public-issues', '校園提案', 'school', true, true, 5, 14, 7,
...
insert into app_private.user_roles (uid, role)
values ('novae-e2e-admin', 'admin'), ('novae-e2e-ordinary', 'user')

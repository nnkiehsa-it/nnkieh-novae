...
insert into app_private.issue_categories (
  ...
  ('public-issues', '校園提案', 'reviewed-school', false, true, true, 50, 14,
...
values
  ('general', '校園設備', false, true, true, 0, 'local-seed'),
  ('facility-a', 'Facility A', false, true, false, 1, 'local-seed'),
  ('facility-b', 'Facility B', false, true, false, 2, 'local-seed')
on conflict (id) do update set

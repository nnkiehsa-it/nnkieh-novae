...
const GROUPS: Array<{ descriptionKey: string; items: RetentionItem[]; titleKey: string }> = [
  ...
  },
  {
    ...
    items: [
      { key: "realtimeEventsHours", unit: "hours" },
      { key: "outboxCompletedDays", unit: "days" },
      { key: "outboxFailedDays", unit: "days" },
      { key: "pushDeliverySentDays", unit: "days" },
      { key: "pushDeliveryFailedDays", unit: "days" },
      { key: "idempotencyHours", unit: "hours" },
      { key: "deletionJobCompletedDays", unit: "days" },
      { key: "deletionJobFailedDays", unit: "days" },
      { key: "maintenanceRunsDays", unit: "days" },
      { key: "platformJobsDays", unit: "days" },
    ],

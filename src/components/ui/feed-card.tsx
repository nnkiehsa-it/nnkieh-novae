  ...
  return (
    <div className="space-y-1.5 rounded-lg bg-secondary px-3 py-2">
      ...
      <div className="h-1.5 overflow-hidden rounded-full bg-border">
        {value !== undefined ? (
          <span className="block h-full origin-left rounded-full bg-tint-content transition-transform duration-300 ease-[var(--ease-smooth-out)]" style={{ transform: `scaleX(${value / 100})` }} />
        ) : null}
      </div>
    </div>
  );

      ...
      >
        {options.map((option) => {
          ...
          <TabsPrimitive.Trigger
            ...
            className="t-tab-label relative isolate inline-flex h-[1.625rem] shrink-0 items-center justify-center gap-1 rounded-full px-3 text-[length:var(--control-label-size)] font-medium leading-3.5 text-muted-foreground outline-none transition-colors duration-[var(--motion-quick)] ease-[var(--ease-smooth-out)] hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/40 data-[state=active]:text-foreground"
            onPointerDown={() => {

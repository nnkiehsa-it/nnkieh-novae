...
const listClasses: Record<Variant, string> = {
  pill: "inline-flex items-center gap-1 rounded-xl bg-card p-1",
  underline: "inline-flex items-center gap-1 border-b border-border",
  segment: "inline-flex items-center gap-0 rounded-lg bg-card p-0.5",
};

export function TabsList({ children, className, ...props }: { children: ReactNode; className?: string } & Omit<ComponentPropsWithoutRef<"div">, "children">) {
    ...
    return (
      ...
      >
        ...
        <motion.span
          ...
          layout="position"
          className={cn(
            "absolute -bottom-px left-0 right-0 h-px bg-[var(--tint-content)]",
            indicatorClassName,
          )}
        />
        ) : null}
    ...
    <div className="relative">
      {active ? (
        <motion.span
          ...
          className={cn(
            "absolute inset-0 bg-[var(--tint-surface)]",
            radius,
            indicatorClassName,
          )}
        />
      ...
      <button
        ...
        className={cn(
          ...
          "transition-colors",
          active
            ? "text-[var(--tint-surface-foreground)]"

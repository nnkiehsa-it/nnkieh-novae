...
- `tests/unit/` — Vitest domain, design-system, request cancellation/timeout, loading-timing, persistent-cache/realtime-idle/Turnstile loading policy, migration checksum, and database-client concurrency behavior tests.
